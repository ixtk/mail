...
import { protectRoute, validateBody, csrfProtection } from "../middleware.js"
...
emailRouter.patch("/:id", protectRoute, csrfProtection, archiveEmail)
emailRouter.delete("/:id", protectRoute, csrfProtection, deleteEmail)
